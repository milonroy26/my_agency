      ...
      <section className="md:py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-wrap mx-4">
            {workList.map((item) => (
              <div key={item.id} className="mb-12 lg:mb-0 w-full md:w-1/2 lg:w-1/3 px-6">
                ...
                <button
                  type="button"
                  className="text-black focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mt-3"
                >
                  Learn More

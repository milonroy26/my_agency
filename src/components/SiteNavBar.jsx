...
const SiteNavBar = () => {
  ...
  return (
    <div>
      <nav className="relative px-6 py-6 flex justify-between items-center z-10 bg-transparent container mx-auto">
        <a className="text-[20px] font-bold leading-[30px]" href="#">

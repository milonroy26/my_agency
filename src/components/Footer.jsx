      ...
      <div className="container mx-auto">
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-14 text-white">
          <div className="flex flex-col gap-3">
            <h2 className="uppercase text-[28px] font-bold font-exo-pro">
              WEB LOGO
            </h2>
            <p className="text-[17px] ">
              Some footer text about the Agency. <br /> Just a little
                ...
                {socialIcon.map((item) => {
                  return (
                    <li key={item.id}>
                      <Link
                        href="#"
                        className="w-[50px] h-[50px] flex items-center  justify-center bg-primary rounded-lg transition-all duration-300 hover:-translate-y-1.5"
                      >
                        {item.icon}
                      </Link>
                    </li>
          ...
          <div className="lg:flex lg:flex-col lg:items-center">
            <h2 className="text-[17px]  font-exo-pro font-semibold">
              Quick Links
            </h2>
              ...
              {quickLink.map((item) => {
                return (
                  <li key={item.id}>
                    <Link
                      href="#"
                      className="hover:text-primary  block hover:translate-x-1.5 transition-all duration-300"
                    >
                      {item.title}
                    </Link>
                  </li>
        ...
        <div className="mt-10">
          <p className="text-white font-exo-pro text-[17px]">
